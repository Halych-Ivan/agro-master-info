...
class AdminRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'plan_full'  => 'nullable|mimes:png,jpg,jpeg,webp,csv,txt,xlx,xls,xlsx,pdf,doc,docx,webp|max:2048',
            'plan_extra'  => 'nullable|mimes:png,jpg,jpeg,webp,csv,txt,xlx,xls,xlsx,pdf,doc,docx,webp|max:2048',
            'plan_dual'  => 'nullable|mimes:png,jpg,jpeg,webp,csv,txt,xlx,xls,xlsx,pdf,doc,docx,webp|max:2048',
            ...
            'passport_date_authority' => 'nullable|string|max:255',

            'code_ident' => 'nullable|string|max:255',

            'student_id' => 'nullable|string|max:255',
            'student_id_series' => 'nullable|string|max:255',
            ...
            'school_document_series' => 'nullable|string|max:255',
