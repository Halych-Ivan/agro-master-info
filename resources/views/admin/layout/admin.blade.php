...
@if(session()->has('alert'))<div class="alert alert-warning" role="alert">{{ session()->get('alert') }}</div>@endif
...
@if(session()->has('primary'))<div class="alert alert-primary" role="alert">{{ session()->get('primary') }}</div>@endif
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">@yield('title', 'Назва розділу')</h1>
        ...
        <footer class="sticky-footer bg-white">
            <div class="container my-auto">
                <div class="copyright text-center my-auto">
                    <span>Copyright &copy; AgroMaster admin-site 2023</span>
                </div>
            </div>
        </footer>
        <!-- End of Footer -->
